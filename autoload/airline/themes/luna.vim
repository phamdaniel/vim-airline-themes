...
let g:airline#themes#luna#palette.normal_modified = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
...
let g:airline#themes#luna#palette.visual_modified = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
